    ...
    <div className='bg-body-secondary position-relative w-100 vh-100'>
      {
        !isLoaded ?
          ...
          <div className='w-100 h-100'>
            ...
            <footer className='position-absolute w-100 bottom-0 z-1 text-center text-white py-1'>Developed by <a href="https://www.linkedin.com/in/piyaremen/" target='_blank' rel='noopener noreferrer'>Piyar Emen</a></footer>
          </div>
      }
